...
function mapEvent(r: any): SDBEvent {
  return {
    ...
    intHomeScore: r.intHomeScore !== null && r.intHomeScore !== undefined && r.intHomeScore !== "" ? Number(r.intHomeScore) : null,
    intAwayScore: r.intAwayScore !== null && r.intAwayScore !== undefined && r.intAwayScore !== "" ? Number(r.intAwayScore) : null,
